...
public class AndroidVideoCapture extends Activity {
	...
	String path = mFileName = Environment.getExternalStorageDirectory()
			.getAbsolutePath() + "/IPS_FILES/Video/";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		myCameraSurfaceView.setOnClickListener(new OnClickListener() {
	...
	Button.OnClickListener myButtonOnClickListener = new Button.OnClickListener() {
		...
		public void onClick(View v) {
			...
			if (recording) {
				...
				// Exit after saved
				AppVariable.VIDEO_FILEPATH = mFileName;
				finish();
				Toast.makeText(getApplicationContext(), "Saved...!",
						Toast.LENGTH_SHORT).show();
			} else {
	...
	private boolean prepareMediaRecorder() {
		...
		String m = mFileName +  System.currentTimeMillis()+ ".mp4";
		mediaRecorder.setOutputFile(m);
		AppVariable.VIDEO_FILEPATH = m;
